...
typedef struct process_thread_control_block{  //---------------------------------------------------------PTCB STRUCT!!!
	int ptid;	
	int exitval;
	TCB* m_thread;
	Task m_task;
...
void initialize_PTCB_table(PCB* pcb);
