...
int pipe_close(void* pipe);
int pipe_read(void* this, char* buf, uint bufsize);
int pipe_write(void* this,const char* buf,uint size);
FCB* socketFCB_reserve(Fid_t *fid);
...
typedef struct socket_control_block{
	...
	PICB* receiver;
	rlnode node;
	struct socket_control_block* connected_to;
	/////////////////////////////////////////////

	/////////////////LISTENER///////////////////
	rlnode queue;
	struct socket_control_block* replicate_to;
	////////////////////////////////////////////
}SOCB;
...
FCB* get_fcb_proc(Fid_t fid,Pid_t pid);
void initializePortTable();
//===================================================================================================
/** 
...
/** @brief Acquire a number of FCBs and corresponding fids.
   ...
   size @ num, this function will check if resources
